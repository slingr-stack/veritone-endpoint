...
# Configuration And Veritone API Token

1. You will need to create an account at Veritone [here](https://www.veritone.com/careers/contact-us/)
2. Login to Veritone in Content Management System [Login](https://login.veritone.com/) (Make sure select the correct environment [stage/prod] and location [us-1/uk-1..])
3. Go to the Admin Console [here](https://admin.veritone.com/organizations)
4. Open the API Keys section and click on "NEW API KEY" bottom.
5. Complete the fields and copy the API Key. 
6. Go to the App Builder of your Application in the section "Endpoints" and click on the button "+ Create" -> Veritone. 
7. Copy the API Key from step 5 (We will complete the fields in the Slingr App again after creating the Veritone App).
...
```js
var stringJsonApplications = JSON.stringify(app.endpoints.veritone.aiDataAdmin.applications.get());
```
